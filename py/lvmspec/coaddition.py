...
class Spectrum(object):
    ...
    Args:
        ...
        resolution(lvmmodel.resolution.Resolution): Sparse matrix of wavelength resolutions.
    """
    def __init__(self,wave,flux=None,ivar=None,mask=None,resolution=None):
        ...
        assert (resolution is None) or (isinstance(resolution, lvmspec.resolution.Resolution))
    ...
    def finalize(self):
        ...
        self.resolution = lvmspec.resolution.Resolution(R)
