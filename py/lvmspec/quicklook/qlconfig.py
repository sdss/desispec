...
class Config(object):
    ...
    def dump_qa(self):
        ...
        Name and default locations of files are handled by lvmspec.io.meta.findfile
        """
...
class Palist(object):
    ...
    def _palist(self):
        ...
        if self.thislist is not None:
            ...
            if self.flavor == 'arcs':
                pa_list=['Initialize','Preproc','BootCalibration','BoxcarExtract','ResolutionFit'] #- class names for respective PAs (see lvmspec.quicklook.procalgs)
                ...
                sys.exit(0)
        self.pamodule='lvmspec.quicklook.procalgs'
        return pa_list
    ...
    def _qalist(self):
        ...
        self.qamodule='lvmspec.qa.qa_quicklook'
        return qalist
