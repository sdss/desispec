...
def resample_spec(wave,flux,outwave,ivar=None):
    ...
    lvmspec.interpolation.resample_flux using weights by ivar does not conserve total S/N.
...
def get_resolution(wave,nspec,psf,usesigma=False):
    ...
    feed resolution data of lvmspec.frame.Frame object.
