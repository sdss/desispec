"""
lvmspec.quicklook.qlresolution
===================
...
class QuickResolution(scipy.sparse.dia_matrix):
    """
    Quicklook version of the resolution mimicking lvmspec.resolution.Resolution
    with some reduction in dimentionality. Contains code from Resolution implementation
    Note that this is similar to lvmspec.resolution.Resolution, though faster and differing
