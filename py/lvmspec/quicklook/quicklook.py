...
from lvmspec.quicklook import qlheartbeat as QLHB
from lvmspec.io import qa as qawriter
from lvmutil.io import yamlify
from lvmspec.quicklook.merger import QL_QAMerger
...
def testconfig(outfilename="qlconfig.yaml"):
    ...
    conf={'BiasImage':os.environ['BIASIMAGE'],# path to bias image
          ...
          'PipeLine':[{'PA':{"ModuleName":"lvmspec.quicklook.procalgs",
                             "ClassName":"BiasSubtraction",
                             "Name":"Bias Subtraction",
                             "kwargs":{"BiasImage":"%%BiasImage"}
                             },
                       'QAs':[{"ModuleName":"lvmspec.qa.qa_quicklook",
                               "ClassName":"Get_RMS",
                               "Name":"Get RMS",
                               "kwargs":{},
                               },
                      ...
                      {'PA':{"ModuleName":"lvmspec.quicklook.procalgs",
                             ...
                             "Name":"2D Extraction",
                             "kwargs":{"PSFFile_sp":"/home/govinda/Desi/lvmmodel/data/specpsf/psf-r.fits",
                                       "Nspec":10,
...
def mapkeywords(kw,kwmap):
    ...
    returned by the lvmspec.io module.
    ...
    for k,v in kw.items():
        ...
        if k in kwmap: #- for configs generated via lvmspec.quicklook.qlconfig
            newmap[k]=kwmap[k]
        else:
            newmap[k]=v
    return newmap
