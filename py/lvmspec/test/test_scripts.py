...
class TestScripts(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        # for k in ('LVM_SPECTRO_REDUX', 'SPECPROD'):
        #     if k in environ:
    ...
    def test_night(self):
        ...
        self.dummy_environment({'LVM_SPECTRO_DATA': 'data',
                                'LVM_SPECTRO_REDUX': 'foo',
                                'SPECPROD': 'bar'})
        ...
        orig_DSR = os.getenv('LVM_SPECTRO_REDUX')
        ...
        if orig_DSR is not None:
            os.environ['LVM_SPECTRO_REDUX'] = orig_DSR
