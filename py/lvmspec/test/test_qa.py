...
from lvmspec.qa.qa_prod import QA_Prod
from lvmspec.io import write_qa_frame, write_qa_brick, load_qa_frame, write_qa_exposure, findfile, write_frame
from lvmspec.io import write_fiberflat, specprod_root
from lvmspec.test.util import get_frame_data, get_calib_from_frame, get_fiberflat_from_frame
...
class TestQA(unittest.TestCase):
    ...
    def test_init_qa_exposure(self):
        ...
        cache_env = {'SPECPROD': None, 'LVM_SPECTRO_REDUX': None}
        for k in cache_env:
            if k in environ:
    ...
    def test_qa_frame_plot(self):
        ...
        from lvmspec.qa import qa_frame
        # Frame
