...
import lvmspec.image as dimg

fake_env_cache = {'LVM_ROOT': None, 'LVM_SPECTRO_DATA': None,
                  'LVM_SPECTRO_REDUX': None, 'SPECPROD': None,
                  'LVMMODEL': None}
...
def fake_env(raw, redux, prod, model):
    ...
    os.environ["LVM_SPECTRO_DATA"] = raw
    os.environ["LVM_ROOT"] = raw
    os.environ["LVM_SPECTRO_REDUX"] = redux
    os.environ["SPECPROD"] = prod
    os.environ["LVMMODEL"] = model
    return
