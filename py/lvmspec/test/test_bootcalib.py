...
from lvmspec.scripts import bootcalib as bootscript
...
class TestBoot(unittest.TestCase):
    ...
    #- lvmspec.bootcalib.bootcalib may be redundant with
    #- lvmspec.scripts.bootcalib.main.  Include tests for both for now.

    #- bootcalib.bootcalib is broken; see https://github.com/desihub/lvmspec/issues/174
    @unittest.expectedFailure
    def test_bootcalib(self):
        from lvmspec.bootcalib import bootcalib
