...
#from lvmspec.maskbits import specmask
from lvmspec.frame import Frame
from lvmspec.fluxcalibration import normalize_templates
from lvmspec.fluxcalibration import FluxCalib
from lvmspec.fluxcalibration import compute_flux_calibration, apply_flux_calibration
from lvmutil.log import get_logger
import lvmspec.io
from lvmspec.test.util import get_frame_data, get_models
...
class TestFluxCalibration(unittest.TestCase):
    ...
    def test_match_templates(self):
        ...
        """
        from lvmspec.fluxcalibration import match_templates
