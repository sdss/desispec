...
class QA_Frame(object):
    ...
    def init_fiberflat(self, re_init=False):
        ...
        QA method is lvmspec.fiberflat.qa_fiberflat
    ...
    def init_skysub(self, re_init=False):
        ...
        QA method is lvmspec.sky.qa_skysub
    ...
    def run_qa(self, qatype, inputs, clobber=True):
        ...
        """
        from lvmspec.sky import qa_skysub
        from lvmspec.fiberflat import qa_fiberflat
        from lvmspec.fluxcalibration import qa_fluxcalib
