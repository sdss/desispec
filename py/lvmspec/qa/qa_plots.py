...
from lvmspec import fluxcalibration as dsflux
...
from lvmspec.io import makepath

from lvmutil.plots import plot_slices as du_pslices
...
def exposure_fiberflat(channel, expid, metric, outfile=None):
    ...
    """
    from lvmspec.io.meta import find_exposure_night, findfile
    from lvmspec.io.frame import read_meta_frame, read_frame
