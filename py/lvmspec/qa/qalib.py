...
def fiducialregion(frame,psf):
    ...
    Args:
        frame: lvmspec.frame.Frame object
...
def sky_continuum(frame, wrange1, wrange2):
    ...
    To be called from lvmspec.sky.qa_skysub and
    lvmspec.qa.qa_quicklook.Sky_Continuum.run_qa
...
def sky_resid(param, frame, skymodel, quick_look=False):
    ...
    To be called from lvmspec.sky.qa_skysub and lvmspec.qa.qa_quicklook.Sky_residual.run_qa
    Args:
        param : dict of QA parameters
        frame : lvmspec.Frame object after sky subtraction
